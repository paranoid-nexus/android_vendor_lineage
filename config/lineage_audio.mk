...
ALARM_PATH := vendor/nexus/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/nexus/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/nexus/prebuilt/common/media/audio/ringtones
